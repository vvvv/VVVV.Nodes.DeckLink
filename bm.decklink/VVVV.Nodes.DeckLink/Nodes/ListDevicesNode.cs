...
namespace VVVV.Nodes.DeckLink
{
	...
	public class ListDevicesNode : IPluginEvaluate
	{
        ...
        protected ISpread<bool> FPinInRefresh;

		[Output("Device")]
        protected ISpread<IDeckLink> FPinOutDevices;

		[Output("Model Name")]
        protected ISpread<string> FPinOutModelName;

		[Output("Display Name")]
        protected ISpread<string> FPinOutDisplayName;

		[Output("Status")]
        protected ISpread<string> FPinOutStatus;
